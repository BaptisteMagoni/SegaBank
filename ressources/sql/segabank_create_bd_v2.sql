...
CREATE TABLE IF NOT EXISTS `agence` (
  ...
  `adresse` varchar(200) COLLATE utf8_bin NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Les données exportées n'étaient pas sélectionnées.

-- Listage de la structure de la table segabank. compte
CREATE TABLE IF NOT EXISTS `compte` (
  ...
  `type` char(1) COLLATE utf8_bin NOT NULL COMMENT 'E = CompteEpargne;S = CompteSimple;P = ComptePayant',
  PRIMARY KEY (`id`),
